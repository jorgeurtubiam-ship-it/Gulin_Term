...
class RpcApiType {
    ...
    // command "toolsdelete" [call]
    ToolsDeleteCommand(client: WshClient, data: string, opts?: RpcOpts): Promise<void> {
        return client.wshRpcCall("toolsdelete", data, opts);
    }

    // command "toolslist" [call]
    ToolsListCommand(client: WshClient, opts?: RpcOpts): Promise<ToolInfo[]> {
        return client.wshRpcCall("toolslist", null, opts);
    }

    // command "toolssave" [call]
    ToolsSaveCommand(client: WshClient, data: ToolInfo, opts?: RpcOpts): Promise<void> {
        return client.wshRpcCall("toolssave", data, opts);
    }
