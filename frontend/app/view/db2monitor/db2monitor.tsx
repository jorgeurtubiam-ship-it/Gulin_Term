...
export class Db2MonitorViewModel {
    viewType = "db2-monitor";
    blockId: string;
    blockAtom: any;
    ...
    get viewComponent() { return Db2MonitorView; }
}
function Db2MonitorView({ model }: { model: Db2MonitorViewModel }) {
    ...
    return (
        <div className="flex flex-col h-full bg-[#1e1e2e] text-white p-6 overflow-auto">
            <h2 className="text-2xl font-black mb-6 text-blue-600"><i className="fa fa-server mr-2"></i> IBM Db2 Gulin-Insights - {model.connectionName}</h2>
