...
export class MongodbMonitorViewModel {
    viewType = "mongodb-monitor";
    blockId: string;
    blockAtom: any;
    ...
    get viewComponent() { return MongodbMonitorView; }
}
function MongodbMonitorView({ model }: { model: MongodbMonitorViewModel }) {
    ...
    return (
        <div className="flex flex-col h-full bg-[#1e1e2e] text-white p-6 overflow-auto">
            <h2 className="text-2xl font-black mb-6 text-green-500"><i className="fa fa-leaf mr-2"></i> MongoDB Gulin-Insights - {model.connectionName}</h2>
