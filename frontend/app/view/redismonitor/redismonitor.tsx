...
export class RedisMonitorViewModel {
    viewType = "redis-monitor";
    blockId: string;
    blockAtom: any;
    ...
    get viewComponent() { return RedisMonitorView; }
}
function RedisMonitorView({ model }: { model: RedisMonitorViewModel }) {
    ...
    return (
        <div className="flex flex-col h-full bg-[#1e1e2e] text-white p-6 overflow-auto">
            <h2 className="text-2xl font-black mb-6 text-red-500"><i className="fa fa-server mr-2"></i> Redis Gulin-Insights - {model.connectionName}</h2>
