...
1. Go to the [Actions tab](https://github.com/jorgeurtubiam-ship-it/Gulin_Term/actions) and select "Bump Version" from the left sidebar.
...
3. After "Bump Version" a "Build Helper" run will kick off automatically for the new version. When this completes, it will generate a [draft GitHub Release](https://github.com/jorgeurtubiam-ship-it/Gulin_Term/releases) with all the built artifacts.
...
Our release builds are managed by the [Build Helper workflow](https://github.com/jorgeurtubiam-ship-it/Gulin_Term/actions/workflows/build-helper.yml).
...
The [Build Helper workflow](https://github.com/jorgeurtubiam-ship-it/Gulin_Term/actions/workflows/build-helper.yml). creates a draft release on GitHub once it completes. You can find this on the [Releases page](https://github.com/jorgeurtubiam-ship-it/Gulin_Term/releases) of the repo. You can use this to download the build artifacts for testing.
