...
func RunWebServer(listener net.Listener) {
	...
	gulinRouter.HandleFunc("/gulin/api-delete", WebFnWrap(WebFnOpts{JsonErrors: true, AllowCaching: false}, aiusechat.GulinAIApiDeleteHandler))
	...
	gulinRouter.HandleFunc("/gulin/chat-delete", WebFnWrap(WebFnOpts{JsonErrors: true, AllowCaching: false}, aiusechat.GulinAIDeleteChatHandler))
	gulinRouter.HandleFunc("/gulin/chat-bulk-delete", WebFnWrap(WebFnOpts{JsonErrors: true, AllowCaching: false}, aiusechat.GulinAIBulkDeleteChatHandler))
	...
	gulinRouter.HandleFunc("/gulin/brain-read", WebFnWrap(WebFnOpts{AllowCaching: false}, aiusechat.GulinAIBrainReadHandler))
	gulinRouter.HandleFunc("/gulin/brain-update", WebFnWrap(WebFnOpts{JsonErrors: true, AllowCaching: false}, aiusechat.GulinAIBrainUpdateHandler))
	gulinRouter.HandleFunc("/gulin/brain-delete", WebFnWrap(WebFnOpts{JsonErrors: true, AllowCaching: false}, aiusechat.GulinAIBrainDeleteHandler))
	gulinRouter.HandleFunc("/gulin/brain/data", WebFnWrap(WebFnOpts{AllowCaching: false}, gulinapp.HandleBrainData))
	gulinRouter.HandleFunc("/gulin/brain/stats", WebFnWrap(WebFnOpts{AllowCaching: false}, gulinapp.HandleBrainStats))
	...
	gulinRouter.HandleFunc("/gulin/plugin-delete", WebFnWrap(WebFnOpts{JsonErrors: true, AllowCaching: false}, aiusechat.GulinAIPluginDeleteHandler))
	...
	gr.HandleFunc("/api/cancel-chat", WebFnWrap(WebFnOpts{AllowCaching: false}, aiusechat.GulinAICancelChatHandler))
	gr.HandleFunc("/api/agent-chat", WebFnWrap(WebFnOpts{AllowCaching: false}, aiusechat.GulinAIAgentChatHandler))
	gr.HandleFunc("/api/agent-log", WebFnWrap(WebFnOpts{AllowCaching: false}, aiusechat.GulinAIAgentLogHandler))
