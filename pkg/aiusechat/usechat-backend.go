...
import (
	...
	"github.com/gulindev/gulin/pkg/aiusechat/bedrock"
...
var _ UseChatBackend = (*bedrock.BedrockBackend)(nil)
...
func GetBackend(apiType string, provider string) (UseChatBackend, error) {
	...
	case uctypes.APIType_AWSBedrock:
		return &bedrock.BedrockBackend{}, nil
	default:
