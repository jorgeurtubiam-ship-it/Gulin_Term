...
func (ws *WshServer) ToolsListCommand(ctx context.Context) ([]wshrpc.ToolInfo, error) {
	return aiusechat.GetAllToolsAdmin(ctx)
}

func (ws *WshServer) ToolsSaveCommand(ctx context.Context, tool wshrpc.ToolInfo) error {
	return aiusechat.SaveToolAdmin(ctx, tool)
}
