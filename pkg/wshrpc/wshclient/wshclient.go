...
// command "toolsdelete", wshserver.ToolsDeleteCommand
func ToolsDeleteCommand(w *wshutil.WshRpc, data string, opts *wshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "toolsdelete", data, opts)
	return err
}

// command "toolslist", wshserver.ToolsListCommand
func ToolsListCommand(w *wshutil.WshRpc, opts *wshrpc.RpcOpts) ([]wshrpc.ToolInfo, error) {
	resp, err := sendRpcRequestCallHelper[[]wshrpc.ToolInfo](w, "toolslist", nil, opts)
	return resp, err
}

// command "toolssave", wshserver.ToolsSaveCommand
func ToolsSaveCommand(w *wshutil.WshRpc, data wshrpc.ToolInfo, opts *wshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "toolssave", data, opts)
	return err
}
...
func WebClickCommand(w *wshutil.WshRpc, data wshrpc.CommandWebClickData, opts *wshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "webclick", data, opts)
	return err
}

// command "webgettext", wshserver.WebGetTextCommand
func WebGetTextCommand(w *wshutil.WshRpc, data wshrpc.CommandWebGetTextData, opts *wshrpc.RpcOpts) (string, error) {
	resp, err := sendRpcRequestCallHelper[string](w, "webgettext", data, opts)
	return resp, err
}
...
// command "webtype", wshserver.WebTypeCommand
func WebTypeCommand(w *wshutil.WshRpc, data wshrpc.CommandWebTypeData, opts *wshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "webtype", data, opts)
	return err
}
